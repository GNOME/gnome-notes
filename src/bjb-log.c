...
#define DEFAULT_DOMAIN_PREFIX "bjb"
                           ...
                           int            verbosity_level)
{
  ...
  if (log_level & BJB_LOG_LEVEL_TRACE)
            ...
            GLogLevelFlags  log_level)
{
  ...
  log_level = log_level & ~BJB_LOG_DETAILED;
...
void
bjb_log_to_file (const char *file_path,
                 gboolean    append)
{
...
const char *
bjb_log_bool_str (gboolean value,
         ...
         ...)
{
  ...
  bjb_log_anonymize_value (str, value);
...
void
bjb_log_anonymize_value (GString    *str,
                         const char *value)
{
